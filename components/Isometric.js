...
export default function Isometric() {
    ...
    const IsoMap = (function () {
        ...
        IsoMap.prototype.drawImg = function (isometricPosition) {
            ...
            let img2 = document.getElementById("scream");
          //  console.log(img2);
            this.context.drawImage(img2, x - (tileWidth + 55) / 2, y - (tileHeight - 25));
        }
        ...
        IsoMap.prototype.drawHand = function (message) {
            try {
                if (this.context) {
